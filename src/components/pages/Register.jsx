...
const Register = () => {
    ...
    if (fullName === "") {
      ...
      createUserWithEmailAndPassword(auth, email, password)
        .then(() => {
          ...
          auth.signOut(); //  Sign out after successful registration
  ...
  return (
    <div className="max-w-[100%] mx-auto">
      <div className="flex items-center justify-between text-rich-black font-bold mt-5 p-1">
        <Link to={"/"}>
      ...
      >
        <label className="relative">
          <input
            ...
            className="my-2 mx-1 w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px] px-6 py-3 rounded-full outline-none border-[1px] border-gray-400 focus:border-mint transition duration-200"
          />
        ...
        <label className="relative">
          <input
            ...
            className="my-2 mx-1 w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px] px-6 py-3 rounded-full outline-none border-[1px] border-gray-400 focus:border-[#45C190] transition duration-200"
          />
        ...
        <div className="flex items-center my-2 py-1 justify-center w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px]">
          <input
            ...
            type="checkbox"
            value=""
            className="w-5 h-5 rounded-full text-[#45C190] bg-gray-100 border-gray-300 focus:ring-[#45C190] dark:focus:ring-[#45C190]dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
          />
          <label
          ...
          >
            I agree with the{" "}
            <span className="text-[#116125ff] dark:text-dartmouth-green hover:underline">
              terms & conditions{" "}
            </span>
            and{" "}
            <span className="text-[#116125ff] dark:text-dartmouth-green hover:underline">
        ...
        <button
          type="submit"
          className="w-[270px] h-[30] xs:w-[360px] xs:h-[40px] md:w-[450px] md:h-[50px] bg-dartmouth-green hover:bg-mint p-2 md:p-0 text-white text-base rounded-full mt-5 md:mt-4"
        >
          Submit
        </button>
        <ToastContainer />
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-gray-600 mt-2 mb-5">
          ...
          <Link to={"/"}>
            <span className="text-dartmouth-green font-medium">Login</span>
          </Link>{" "}
        </div>
      </div>
    </div>
